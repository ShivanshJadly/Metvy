...
import { SelectedResumesBar } from "./selected-resume-bar";
...
function PureMessages({
  ...
  return (
    <div className="flex flex-1 flex-col">
      ...
      <SelectedResumesBar
        onClear={onClearUuids}
        onSubmit={onSubmitUuids}
        onToggle={onUuidSelect}
        uuids={selectedResumeUuids}
      />
    </div>
  );
}
